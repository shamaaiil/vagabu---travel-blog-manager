...
const BussinessPreferredVerification = () => {
  const columns = [
  ...
  return (
    <>
      <div className="mt-12 px-8">
        <DynamicTable
          tableTitle="Business Line Credit Application Verification"
          columns={columns}
      ...
      {isEditModalOpen && (
        <DynamicModal
          title="Business Line Credit Application Verification"
          fields={[]}
        />
      )}
    </>
...
export default BussinessPreferredVerification;
