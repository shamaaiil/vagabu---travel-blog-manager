  ...
  useEffect(() => {
    if (ordersData) {
      ...
      if (Array.isArray(ordersData.data)) {
        const declinedOrders = ordersData.data.filter((order) => {
          return order.status && order.status.toLowerCase() === "declined";
        });

        const formattedOrders = declinedOrders.map((order) => {
