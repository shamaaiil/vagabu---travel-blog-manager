  ...
  useEffect(() => {
    if (ordersData) {
      ...
      if (Array.isArray(ordersData.data)) {
        const refundedOrders = ordersData.data.filter((order) => {
          return order.status && order.status.toLowerCase() === "refunded";
        });

        const formattedOrders = refundedOrders.map((order) => {
